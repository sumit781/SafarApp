...
export default function ButtonComponent({title="",onPress,styleText,styleButton={}}) {
  return (
    <TouchableOpacity style={[{width:Dimensions.get('window').width*.6,height:50,justifyContent:'center',alignItems:'center',backgroundColor:"white",marginTop:35,borderRadius:25,shadowColor: '#171717',
